...
function (_React$PureComponent) {
  ...
  _proto._computeState = function _computeState(props) {
    ...
    return {
      childProps: (0, _extends2.default)({}, props, {
    ...
    _this._onViewableItemsChanged = function (_ref) {
      ...
      if (_this.props.onViewableItemsChanged) {
        _this.props.onViewableItemsChanged({
          viewableItems: viewableItems.map(_this._convertViewable, (0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).filter(Boolean),
          changed: changed.map(_this._convertViewable, (0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this))).filter(Boolean)
        });
      }
    };
  ...
  _proto.render = function render() {
    return _react.default.createElement(_VirtualizedList.default, (0, _extends2.default)({}, this.state.childProps, {
...
VirtualizedSectionList.defaultProps = (0, _extends2.default)({}, _VirtualizedList.default.defaultProps, {
  data: []
});
...
function (_React$Component) {
  (0, _inheritsLoose2.default)(ItemWithSeparator, _React$Component);
      ...
      updateProps: function updateProps(select, newProps) {
        ...
        if (select === 'leading' && LeadingSeparatorComponent) {
          _this2.setState(function (state) {
            return {
              leadingSeparatorProps: (0, _extends2.default)({}, state.leadingSeparatorProps, newProps)
            };
          });
        } else {
  ...
  _proto2.UNSAFE_componentWillReceiveProps = function UNSAFE_componentWillReceiveProps(props) {
    ...
    this.setState(function (state) {
      return {
        separatorProps: (0, _extends2.default)({}, _this3.state.separatorProps, {
        ...
        leadingSeparatorProps: (0, _extends2.default)({}, _this3.state.leadingSeparatorProps, {
