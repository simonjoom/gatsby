...
var TouchableHighlight = (0, _createReactClass.default)({
  ...
  getInitialState: function getInitialState() {
    ...
    return (0, _extends2.default)({}, this.touchableGetInitialState(), this._computeSyntheticState(this.props));
  },
  ...
  _hideUnderlay: function _hideUnderlay() {
    ...
    if (this._hasPressHandler() && this._underlayRef) {
      ...
      this._underlayRef.setNativeProps((0, _extends2.default)({}, INACTIVE_UNDERLAY_PROPS, {
  ...
  render: function render() {
    var _this$props = this.props,
        ...
        other = (0, _objectWithoutPropertiesLoose2.default)(_this$props, ["activeOpacity", "onHideUnderlay", "onShowUnderlay", "underlayColor", "delayLongPress", "delayPressIn", "delayPressOut", "onLongPress", "onPress", "onPressIn", "onPressOut", "pressRetentionOffset"]);
