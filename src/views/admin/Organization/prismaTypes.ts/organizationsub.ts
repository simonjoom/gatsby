...
export interface organizationsub_organization_node_country {
  id: string;
  name: string;
}

export interface organizationsub_organization_node_category {
  id: string;
  name: string;
}
...
export interface organizationsub_organization_node {
  ...
  budget: number | null;
  bid: number | null;
  country: organizationsub_organization_node_country[] | null;
  category: organizationsub_organization_node_category[] | null;
