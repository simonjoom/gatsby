...
const translations = {
  en: {
    ...
    name_organization: 'Business:',
    email_person: 'Email:',
    phone_person: 'Phone:',
    name_product: 'Product Name:',
    name_pipeline: 'Pipeline Name:',
    title_deal: 'Title Deal:',
    value_deal: 'Deal:',
    currency_deal: 'Currency:',
    order_nr_pipeline: 'Position',
    unit_product: 'Phone:',
    code_product: 'Product Code',
    description_resort: 'description resort',
    name_resort: 'name resort*',
    phoneNumber_resort: 'phone resort*',
    city_resort: 'city resort*',
    address_resort: 'address resort',
    zipCode_resort: 'zipcode resort',
    Create_resort: 'New resort',
    APIREADME: 'API README',
    // Globals
    yes: 'Yes',
    loading: 'Loading...',
    ...
    choose_your_resort: 'Choose your resort!',
    change_your_resort_later:
      "In the future, if you wish to change your resort, go your account's settings",
    ...
    product_not_available:
      'Product not available. Please remove it from your cart.',
  ...
  fr: {
    ...
    first_name: 'Prénom',
    last_name: 'Nom',
    are_you_instructor: 'Êtes vous Moniteur de ski ?',
    ...
    choose_your_resort: 'Choisissez votre station de ski !',
    change_your_resort_later:
      'A l’avenir si vous souhaitez changer de station, rendez-vous dans vos paramètres de compte.',

    choose_your_store: 'Choisissez votre boutique !',
    change_your_store_later:
      'A l’avenir si vous souhaitez changer de boutique, rendez-vous dans vos paramètres de compte.',
    finish_sign_up: 'Finalisez votre inscription',
    hard_password:
      'Faites en sorte que votre mot de passe soit impossible à deviner, même pour un membre de votre famille ou un ami(e)',
    ...
    invalid_cart_deleted:
      'Votre panier contient des produits qui ont été retiré de la vente par votre boutique.\n Veuillez les enlever de votre panier avant de continuer.',
    invalid_cart_not_available:
    ...
    accept_gtc:
      'En validant votre commande, vous acceptez l’intégralité de nos CGV ainsi que notre politique de gestion de vos informations personnelles.',
    ...
    // After payment translations
    congratz_payment:
      'Félicitations, votre commande est bien prise en compte ! 🎉',
    will_receive_notif:
      'Vous recevrez une notification dès que nous aurons préparé votre commande.',
