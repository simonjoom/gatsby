...
function (_Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$props3 = this.props,
        ...
        handleRef = _this$props3.handleRef,
        other = (0, _objectWithoutPropertiesLoose2.default)(_this$props3, ["accessibilityLabel", "accessible", "blurRadius", "defaultSource", "draggable", "source", "testID", "capInsets", "style", "styleAccessibilityImage", "styleImage", "onError", "onLayout", "onLoad", "onLoadEnd", "onLoadStart", "resizeMethod", "resizeMode", "handleRef"]);
    ...
    var hiddenImage = displayImageUri ? (0, _createElement.default)('img', {
      ...
      ref: this._setImageRef && handleRef,
      src: displayImageUri,
    ...
    return _react.default.createElement(_View.default, (0, _extends2.default)({}, other, {
      ...
      style: [_StyleSheet.default.flatten([styles.image, styleImage]), resizeModeStyles[finalResizeMode], this._getBackgroundSize(finalResizeMode), backgroundImage && {
